    ...
    return (
      <div className="flex min-h-dvh flex-col bg-cream dark:bg-[#1a1917]">
        <div className="flex flex-1 flex-col items-center justify-center px-6 pb-12">
          ...
          <h1 className="mt-6 text-3xl font-bold tracking-tight text-[#2c2825] dark:text-[#f0ebe3]">
            Grocery List
          </h1>
        ...
        <div className="safe-bottom space-y-3 px-6 pb-8">
          ...
          <button
            ...
            className="w-full rounded-2xl border-2 border-sage/30 bg-white py-4 text-lg font-semibold text-sage active:bg-sage/5 dark:border-sage/40 dark:bg-[#2a2825] dark:text-sage-light"
          >
            Join with Code
          </button>
        </div>
  ...
  return (
    <div className="flex min-h-dvh flex-col bg-cream dark:bg-[#1a1917]">
      <header className="safe-top flex items-center gap-3 px-4 pt-4">
        ...
        <h2 className="text-xl font-semibold text-[#2c2825] dark:text-[#f0ebe3]">
      ...
      >
        <label className="block">
          ...
          <input
            ...
            required
            autoFocus
            className="mt-2 w-full rounded-xl border border-cream-dark bg-white px-4 py-3.5 text-lg outline-none focus:border-sage focus:ring-2 focus:ring-sage/20 dark:border-[#3a3835] dark:bg-[#2a2825] dark:text-[#f0ebe3]"
          />
        </label>
        ...
        {isCreate ? (
          ...
          <label className="mt-5 block">
            ...
            <input
              ...
              required
              maxLength={8}
              className="mt-2 w-full rounded-xl border border-cream-dark bg-white px-4 py-3.5 text-center font-mono text-2xl tracking-widest outline-none focus:border-sage focus:ring-2 focus:ring-sage/20 dark:border-[#3a3835] dark:bg-[#2a2825] dark:text-[#f0ebe3]"
            />
          </label>
        )}
        ...
        <div className="safe-bottom mt-auto pb-8 pt-8">
          <button
            ...
            className="w-full rounded-2xl bg-sage py-4 text-lg font-semibold text-white disabled:opacity-50 active:bg-sage-dark"
          >
